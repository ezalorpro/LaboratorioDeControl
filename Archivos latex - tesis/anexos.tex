...
\AgregarAnexo{Repositorio publico en Github}{anexo:repositorio}

    Todo el código fuente de la aplicación y la documentación de la misma pueden ser encontradas en un repositorio publico de Github, en el mismo se publico adicionalmente una rama de desarrollo con código extra incluyendo los códigos y la data utilizada para el proceso de comparación. En los siguientes enlaces se puede acceder a toda la información:

    \vspace{10pt}

    \noindent Repositorio: \href{https://github.com/ezalorpro/LaboratorioVirtual}{https://github.com/ezalorpro/LaboratorioVirtual}

    \vspace{10pt}

    \noindent Rama de desarrollo: \href{https://github.com/ezalorpro/LaboratorioVirtual/tree/Development}{https://github.com/ezalorpro/LaboratorioVirtual/tree/Development}

    \vspace{10pt}
    
    \noindent Documentación: \href{https://laboratoriovirtual.readthedocs.io/es/latest/}{https://laboratoriovirtual.readthedocs.io/es/latest/}