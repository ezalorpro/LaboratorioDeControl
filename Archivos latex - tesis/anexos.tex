...
% Sintaxis para agregar un anexo:
    ...
    % El anexo puede ser referenciado luego en el texto utilizando \ref{anexo:label_del_anexo}, si es el primer anexo,
    % se representara como [Anexo A] al utilizar \ref{}
...
\AgregarAnexo{Comparacion de simulacion de sistemas de control}{anexo:ComparacionSimC}
