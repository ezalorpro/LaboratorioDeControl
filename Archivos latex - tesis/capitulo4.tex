...
\section{Comparacion con MATLAB y SciLab}
    ...
    \subsection{Funcion de analisis de sistemas de control}
        ...
        Para realizar la comparacion entre el Laboratorio Virtual, MATLAB y SciLab se seleccionaron tres sistemas distintos, los sistemas fueron seleccionados de modo que abarcaran la mayoria de funciones disponibles. En la \cref{tab:AnalisisSistemas} se puede observar los sistemas a utilizar, los sistemas discretos se obtuvieron utilizando un ZOH, transformacion Tustin y un FOH respectivamente, con periodos de muestreo de 0.1s, 0.2s y 0.05s en cada caso.
        ...
        \begin{table}[htb]
            ...
            \begin{threeparttable}
                ...
                \begin{tabular*}{\textwidth}{c @{\extracolsep{\fill}}c}
                    \toprule
                            Continuo & Discreto \\ \midrule \renewcommand{\arraystretch}{4}
                $\dfrac{1}{s^2 + s + 1} $ & $\dfrac{0.004833 z+0.004675}{z^2 - 1.895 z + 0.9048} $  \\[20pt]
                \begin{tabular}[x]{@{}c@{}c} \renewcommand{\arraystretch}{1} $A=\begin{bmatrix} -0.5 & -3 & -0.2 \\
                    1 & 0 & 0 \\
                    0 & 1 & 0 
                ...
                $\dfrac{s + 2}{s^2 + 0.5s + 3}e^{-1.5s} $ & $z^{-30}\left(\dfrac{0.02561 z^2 + 0.003084  z - 0.02375}{z^2 - 1.968 z + 0.9753}\right)$\\[8pt] \bottomrule
                \end{tabular*}
        ...
        Para poder realizar los calculos numericos de error, area y distancia se realizo una interpolacion con el fin de ajustar el numero de muestras entre los vectores de tiempo y en frecuencia y los valores correspondientes, i.g., que ambos vectores de salida tengan un valor de salida para t=0.5s. En el caso de MATLAB, la funciones de analisis de sistemas de control crean su propio vector de tiempo y frecuencia segun sea el caso, por otro lado, en SciLab se deben asignar los valores de forma explicita, por tanto, se utilizo el vector de tiempo del Laboratoio Virtual y el vector de frecuencia de MATLAB. Con las consideraciones anteriores se realizo la comparacion respectiva y se obtuvieron los resultados observados en las siguientes tablas:
        
        \begin{table}[htb]
            \centering
            \begin{threeparttable}
                \scriptsize
                \renewcommand{\arraystretch}{1} 	% Separacion de las filas
                %\setlength{\tabcolsep}{6pt}			% Separacion de columnas
                \caption[Comparacion de analisis - respuesta escalon - tiempo continuo]{Comparacion de la respuesta escalon para los sistemas en tiempo continuo}
                \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} ccccc}
                	\toprule
                	                             &    \multicolumn{3}{c}{MATLAB}     & \multicolumn{2}{c}{SciLab} \\
        ...
        \begin{table}[!h]
            ...
            \begin{threeparttable}
                ...
                \renewcommand{\arraystretch}{1} 	% Separacion de las filas
                %\setlength{\tabcolsep}{6pt}			% Separacion de columnas
                \caption[Comparacion de analisis - respuesta impulso - tiempo continuo]{Comparacion de la respuesta impulso para los sistemas en tiempo continuo}
                \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} ccccc}
                	\toprule
                	                             &    \multicolumn{3}{c}{MATLAB}     & \multicolumn{2}{c}{SciLab} \\
                    \cmidrule{2-4}\cmidrule{5-6}
                	...
                	RECM                         & \num{2.026E-06} & \num{4.125E-06} & \num{7.657E-06} & \num{1.557E-12} & \num{5.246E-11}  \\
                	Diferencia de area           & \num{8.168E-06} & \num{1.290E-05} & \num{1.600E-05} & \num{1.422E-12} & \num{2.720E-09}  \\
                	Distancia de energia         & \num{1.120E-04} & \num{5.985E-05} & \num{1.712E-04} & \num{3.540E-08} & \num{9.027E-08}  \\ \bottomrule
                \end{tabular*}
                \label{tab:AnalisisImpC}
            \end{threeparttable}
        \end{table}
        ...
        \begin{table}[htb]
            ...
            \begin{threeparttable}
                ...
                \renewcommand{\arraystretch}{1} 	% Separacion de las filas
                %\setlength{\tabcolsep}{6pt}			% Separacion de columnas
                \caption[Comparacion de analisis - Bode - tiempo continuo]{Comparacion de Bode para los sistemas en tiempo continuo}
                \begin{tabular*}{\textwidth}{l @{\extracolsep{\fill}} ccccc}
                	\toprule
                	                             &    \multicolumn{3}{c}{MATLAB}     & \multicolumn{2}{c}{SciLab} \\
                    \cmidrule{2-4}\cmidrule{5-6}
                    Sistema 					 & 1               &     2      & 3  & 1  & 2 \\
                    Magnitud 					 &                &           &   &   &  \\ \cmidrule{1-1}
                	Diferencia absoluta          & \num{1.117E-05} & \num{4.449E-05} & \num{4.489E-05} & \num{4.473E-12} & \num{1.129E-10}  \\
                	Diferencia porcentual        & \num{6.702E-03} & \num{3.385E-03} & \num{3.514E-03} & \num{8.514E-07} & \num{1.717E-05}  \\
                	RECM                         & \num{2.026E-06} & \num{4.125E-06} & \num{7.657E-06} & \num{1.557E-12} & \num{5.246E-11}  \\
                	Diferencia de area           & \num{8.168E-06} & \num{1.290E-05} & \num{1.600E-05} & \num{1.422E-12} & \num{2.720E-09}  \\
        ...
        %         \centering
        %         \includegraphics[width=0.4\textwidth,valign=c]{MATLAB/Set1Step.png}
        %         \includegraphics[width=0.4\textwidth,valign=c]{MATLAB/Set1Imp.png}
        %         \includegraphics[width=0.4\textwidth,valign=c]{MATLAB/Set1Bode.png}
        %         \includegraphics[width=0.4\textwidth,valign=c]{MATLAB/Set1Nyquist.png}
        %         \includegraphics[width=0.4\textwidth,valign=c]{MATLAB/Set1Rlocus.png}
        %         \includegraphics[width=0.4\textwidth,valign=c]{MATLAB/Set1Nichols.png}
        %         \label{fig:Set1sub}
        %     \end{subfigure}
        %     \caption[Comparacion de analisis - respuesta escalon]{\textbf{Respuesta escalon para el sistema 1}. a) Sistema continuo, b) Sistema discreto \label{fig:Set1}}
        % \end{figure}
