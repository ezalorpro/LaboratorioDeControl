...
\section{Comparacion con MATLAB y SciLab}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[width=0.4\textwidth]{Scilab/Set2Imp.png}
        \caption[bla bla bla]{\textbf{Diagrama general de la aplicación}. La estructura general de la aplicación, la segunda columna representa a los archivos handler mientras que la tercera son los archivos de rutinas. Fuente: Elaboración propia.} 
        \label{fig:estructuraMain}
    \end{figure}