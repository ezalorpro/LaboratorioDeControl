...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None):
        ...
        self.main.sscalcButton1.clicked.connect(self.calcular_analisis)
        
        self.main.tfdiscretocheckBox1.stateChanged.connect(self.bool_discreto)
        
        self.main.tfradioButton1.toggled.connect(self.stacked_to_tf)
        self.main.ssradioButton1.toggled.connect(self.stacked_to_ss)

    def calcular_analisis(self):
        if self.main.tfdiscretocheckBox1.isChecked() and self.main.AnalisisstackedWidget.currentIndex() == 0:      
            self.dt = json.loads(self.main.tfperiodoEdit1.text())
        elif self.main.ssdiscretocheckBox1.isChecked() and self.main.AnalisisstackedWidget.currentIndex() == 1:
