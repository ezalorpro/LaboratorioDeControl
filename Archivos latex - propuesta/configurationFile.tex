...
\BeforeBeginEnvironment{minted}{\begin{tcolorbox}[colback=colorcodes]}
\AfterEndEnvironment{minted}{\end{tcolorbox}}

\BeforeBeginEnvironment{listing}{\vspace*{-2pt}}
...
\renewcommand{\listoflistings}{%
	\phantomsection
	\addcontentsline{toc}{chapter}{\protect{\uppercase{\listoflistingscaption}}}%
