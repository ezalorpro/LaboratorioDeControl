...
\newcommand{\NumeradoFormat}{
	...
	% setup de caption y ambiente de tablas
	\captionsetup[table]{textfont=bf, format=plain, justification=justified, singlelinecheck=false, labelsep=period, skip=1pt}
	...
	\titlecontents{section}% <section-type>
		[1cm + 0.5cm + \widthof{\thesection}]% <left>
		{\addvspace{-2pt}}% <above-code>
	...
	\titlecontents{subsection}% <section-type>
		[1.5cm + \widthof{\thesection} + 0.5cm + \widthof{\thesubsection}]% <left>
		{\addvspace{-2pt}}% <above-code>
	...
	\titlecontents{subsubsection}% <section-type>
		[2cm + \widthof{\thesection} + \widthof{\thesubsection} + 0.5cm + \widthof{\thesubsubsection}]% <left>
		{\addvspace{-2pt}}% <above-code>
	...
	\titlecontents{paragraph}% <section-type>
		[6.52cm]% <left>
		{\addvspace{0pt}}% <above-code>
		{\makebox[\widthof{\thecontentslabel}][l]{\thecontentslabel}\hspace{0.5cm}}% <numbered-entry-format>
		{}% <numberless-entry-format>
		{\titlerule*[8pt]{.}\contentspage}[\addvspace{0pt}]
}
