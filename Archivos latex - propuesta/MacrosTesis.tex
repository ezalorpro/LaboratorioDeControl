...
\newcommand{\UnetFormat}{
	...
	\captionsetup[figure]{labelformat=simple,labelsep=period, labelfont=bf, textfont=footnotesize, justification=justified, singlelinecheck=false}
	
	\captionsetup[subfigure]{labelsep=period, labelfont=bf, textfont=normal, justification=centering, singlelinecheck=false}
...
\newcommand{\NumeradoFormat}{
	...
	\titleformat{\subsubsection}[block]{\large\bfseries\itshape}{\thesubsubsection}{1em}{}
	\titleformat{\paragraph}[runin]{\normalsize\bfseries\itshape }{\theparagraph}{1em}{\addperiod}
	
	\titlespacing\section{0pt}{0pt plus 4pt minus 4pt}{0pt plus 4pt minus 4pt}
	\titlespacing\subsection{1.5cm}{0pt plus 4pt minus 4pt}{0pt plus 4pt minus 4pt}
	\titlespacing\subsubsection{1.5cm}{0pt plus 4pt minus 4pt}{0pt plus 4pt minus 4pt}
	\titlespacing{\paragraph}{1.5cm}{0pt plus 4pt minus 4pt}{0pt plus 4pt minus 4pt}
	
	% setup de caption y ambiente de tablas
	\captionsetup[table]{textfont=bf, format=plain, justification=centering, singlelinecheck=false, labelsep=period, skip=1pt}
	
	% setup de caption y ambiente de figuras
	\captionsetup[figure]{labelformat=simple,labelsep=period, labelfont=bf, textfont=normal, justification=centering, singlelinecheck=false}
	
	\captionsetup[subfigure]{labelsep=period, labelfont=bf, textfont=normal, justification=centering, singlelinecheck=false}
	
	\captionsetup[listing]{format=plain, justification=centering, singlelinecheck=false, labelsep=period}
...
\AfterEndEnvironment{align}{\vspace{-27pt}\leavevmode}
