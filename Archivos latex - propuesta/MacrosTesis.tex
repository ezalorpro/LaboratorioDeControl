...
\newcommand{\NumeradoFormat}{
	...
	\titleformat{\paragraph}[runin]{\normalsize\bfseries\itshape}{\theparagraph}{0.5em}{\addperiod}
	...
	\setlength{\sectionlenght}{-0.4cm - \widthof{\thesection}}

	\newlength\subsectionlenght
	\setlength{\subsectionlenght}{-0.4cm - \widthof{\thesubsection}}

	\newlength\subsubsectionlenght
	\setlength{\subsubsectionlenght}{-0.4cm - \widthof{\thesubsubsection}}

	\newlength\paragraphlenght
	\setlength{\paragraphlenght}{-0.4cm - \widthof{\theparagraph}}

	\titlecontents{section}% <section-type>
		[0.4cm + \widthof{\thesection}]% <left>
		{\addvspace{-2pt}}% <above-code>
		{\hspace{\sectionlenght}\makebox[\widthof{\thecontentslabel}][l]{\thecontentslabel}\hspace{0.4cm}}% <numbered-entry-format>
		{}% <numberless-entry-format>
		{\titlerule*[8pt]{.}\contentspage}[\addvspace{-2pt}]
	
	\titlecontents{subsection}% <section-type>
		[0.4cm + \widthof{\thesection} + 0.4cm + \widthof{\thesubsection}]% <left>
		{\addvspace{-2pt}}% <above-code>
		{\hspace{\subsectionlenght}\makebox[\widthof{\thecontentslabel}][l]{\thecontentslabel}\hspace{0.4cm}}% <numbered-entry-format>
		{}% <numberless-entry-format>
		{\titlerule*[8pt]{.}\contentspage}[\addvspace{-2pt}]
		
	\titlecontents{subsubsection}% <section-type>
		[0.8cm + \widthof{\thesection} + \widthof{\thesubsection} + 0.4cm + \widthof{\thesubsubsection}]% <left>
		{\addvspace{-2pt}}% <above-code>
		{\hspace{\subsubsectionlenght}\makebox[\widthof{\thecontentslabel}][l]{\thecontentslabel}\hspace{0.4cm}}% <numbered-entry-format>
		{}% <numberless-entry-format>
		{\titlerule*[8pt]{.}\contentspage}[\addvspace{-2pt}]
		
	\titlecontents{paragraph}% <section-type>
		[1.2cm + \widthof{\thesection} + \widthof{\thesubsection} + \widthof{\thesubsubsection} + 0.4cm + \widthof{\theparagraph}]% <left>
		{\addvspace{-2pt}}% <above-code>
		{\hspace{\paragraphlenght}\makebox[\widthof{\thecontentslabel}][l]{\thecontentslabel}\hspace{0.4cm}}% <numbered-entry-format>
		{}% <numberless-entry-format>
		{\titlerule*[8pt]{.}\contentspage}[\addvspace{-2pt}]
}
