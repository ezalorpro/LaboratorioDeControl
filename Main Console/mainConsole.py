...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    [Clase principal del programa, esta clase hereda de QMainWindow y Ui_MainWindow, la primera es la clase base
     ...
     son los manejadores de cada una de las funcionalidades del laboratorio virtual, estos Handlers se tratan 
     como si fueran una extension de esta clase, por tanto, se les envia self y se recibe self y se sigue 
     tratando como si fuera parte de la clase]
