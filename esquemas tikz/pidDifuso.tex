...
\begin{tikzpicture}[auto, >=latex']
    ...
    \node [block1, node distance=0.45cm, right = of filtrojoint] (derivada) {$\frac{Ns}{1+\frac{N}{s}}$};
    \node [block1, below = of derivada] (derivada2) {$\left(\frac{Ns}{1+\frac{N}{s}}\right) ^{2}$};
