...
\begin{tikzpicture}[auto, >=latex']
    ...
    \node [block1, right = of sum] (filtro) {$\frac{1}{0.1s + 1}$};
    \node [fuzzyBlock, minimum height=2em, minimum width=3em, node distance=0.6cm, draw, right = of filtro] (controller) {};
    ...
    \draw [->] (sensor) -| node[pos=0.99, right] {$-$} node [pos=.25, above] {} (sum);
