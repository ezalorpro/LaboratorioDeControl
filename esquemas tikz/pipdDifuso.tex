...
\begin{tikzpicture}[auto, >=latex']
    ...
    \node [block1, node distance=0.45cm, right = of filtro] (derivada) {$\frac{Ns}{1+\frac{N}{s}}$};
    ...
    \node [fuzzyBlock, label=above:$PD$, minimum height=2em, minimum width=3em, node distance=0.6cm, draw, above = of controller] (controller2) {};
    ...
    \draw [->] (controller2) -| node[pos=0.97, left] {\tiny{$+$}} (sum2);
